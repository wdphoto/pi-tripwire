...
The internal implementation path can change, for example from `src/index.ts` to another package-internal location, as long as `extensions/tripwire/index.ts` and `package.json` are updated together.
